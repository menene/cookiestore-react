  ...
  return (
    <Card className="group flex flex-col hover:-translate-y-1 hover:shadow-md transition-all duration-200">
      ...
      <CardFooter className="p-5 pt-0 flex items-center justify-between">
        ...
        {/* Al hacer clic, se llama a onAgregar con el objeto completo de la galleta.
            App recibe este objeto y lo añade al array del carrito. */}
        <Button size="sm" onClick={() => onAgregar(cookie)}>
